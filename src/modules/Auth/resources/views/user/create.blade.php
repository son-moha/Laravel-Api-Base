...
@section('toolbar')
    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
            ...
            <li class="breadcrumb-item text-muted">{{ trans('core::common.create') }}</li>
        </ul>
    </div>
@endsection
@section('content')
    <div class="card">
        <div class="card-body py-4">
            <form action="{{route('cp.users.store')}}" method="post" class="form-horizontal form-label-left form_validation form_submit_check" autocomplete="off" enctype="multipart/form-data">
                <div class="form">
                    <div class="form_content">
                        ...
                        <div class="fv-row mb-8 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input class="form-control form-control-solid mb-2 mb-lg-0" name="name" value="{{ old('name') }}" type="text"/>
                            @error('name')
                        ...
                        <div class="fv-row mb-8 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="mt-1">
                                ...
                                <div class="image-input image-input-empty" id="avt-preview" data-kt-image-input="true" style="background-image: url({{asset('dist/media/svg/avatars/blank.svg')}});">
                                    ...
                                    title="Change avatar">
                                        ...
                                        <input type="file" id="file-input" name="avatar" accept=".png, .jpg, .jpeg"/>
                        ...
                        <div class="fv-row mb-8 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input class="form-control form-control-solid mb-2 mb-lg-0" value="{{ old('phone_number') }}" name="phone_number" type="tel"/>
                            @error('phone_number')
                                <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
                        <div class="fv-row mb-8 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input class="form-control form-control-solid mb-2 mb-lg-0" value="{{ old('address') }}" name="address" type="text" />
                            @error('address')
                                <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
                        <div class="fv-row mb-8 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input class="form-control form-control-solid mb-2 mb-lg-0"  type="text" id="email" name="email" value="{{ old('email') }}" />
                            @error('email')
                                <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
                            ...
                            <div class="row ps-3">
                                @foreach($roles as $role)
                                    <div class="col-5 form-check form-check-custom form-check-solid mb-4">
                                        <input class="form-check-input" name="role_id[]" type="checkbox" value="{{$role->id}}"  @if(old('role_id') == $role->id) checked @endif id="flexCheckDefault role_id"/>
                        ...
                        <div class="fv-row mb-8 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="row ps-3">
                                <div class="form-check form-check-custom form-check-solid mb-5">
                                    <input class="form-check-input me-3" name="status" type="radio" value="1" id="kt_docs_formvalidation_radio_option_1" />
                            ...
                            <div class="row ps-3">
                                <div class="form-check form-check-custom form-check-solid mb-5">
                                    <input class="form-check-input me-3" name="status" type="radio" value="0" checked id="kt_docs_formvalidation_radio_option_1" />
                                    <label class="form-check-label" for="kt_docs_formvalidation_radio_option_1">
                        ...
                        <div class="fv-row mt-5 mb-8 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <a href="{{ back_link() }}" class="btn btn-secondary pull-right mr-2">
